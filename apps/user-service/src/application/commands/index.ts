...
import { LoginUserCommand } from './user/definitions/login_user';
...
import { LoginUserCommandHandler } from './user/login_user.handler';
...
export const configures = (bind: interfaces.Bind) => {
  bind<ICommandHandler<LoginUserCommand>>(G_TYPES.CommandHandler).to(LoginUserCommandHandler);
